...
//    echo "<script>alert('{$birthday}')</script>";
    ...
    $updateuser = "UPDATE user SET uname='$uname', email='$email' WHERE uid=$uid";
    $update1 = mysqli_query($link,$updateuser);

    $updateuserdetail = "UPDATE usersetting SET realname='$name', city='$city', birthday='$birthday' WHERE uid=$uid";
    $update2 = mysqli_query($link,$updateuserdetail);
...
<!--                        </li>-->
                    ...
                    <br />
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" required="required" class="form-control" name="uname"
                                   value=<?php if($uname != null) echo $uname;?>>
                        </div>
                        <div class="form-group">
                            <label>Name </label>
                            <input type="text" class="form-control" name="realname"
                                   value=<?php if($realname != null) echo $realname;?>>
                        </div>
                        <div class="form-group">
                            <label>email * </label>
                            <input type="email" required="required" class="form-control" name="email"
                                   value=<?php if($email != null) echo $email;?>>
                        </div>
                        <div class="form-group">
                            <label>City </label>
                            <input type="text" class="form-control" name="city"
                                   value=<?php if($city != null) echo $city;?>>
                        </div>

                        <div class="form-group">
                            <label>Birthday </label>
                            <input type="date" class="form-control" name="birthday"
                                   value=<?php if($birthday != null) echo $birthday;?>>
                        </div>
